        ...
        <div className='bg-[#2874f0] fixed top-0 right-0 left-0 z-30 '>
            <nav className=' max-w-[1700px] m-auto py-3 md:px-8 flex md:justify-evenly justify-between items-center '>
                <div className="hamburger ml-3 flex md:hidden items-center" onClick={onClick}>
                    ...
                    <div>
                        <Link className='italic font-bold text-white px-2 text-xl flex items-center mr-1 cursor-pointer' to="/">BigMart</Link>
                    </div>
                </div>
                <div className="logo flex w-1/2">
                    <Link to="/" className='italic font-bold text-white px-2 text-xl items-center mr-1 cursor-pointer hidden md:flex'>BigMart</Link>
                ...
                <div className={`text-white ${logged && 'space-x-9'} flex justify-evenly items-center`}>
                    {logged && <><div className="dropdown hidden md:block cursor-pointer">
                        ...
                        <div className="dropdown hidden md:block cursor-pointer">
                            <span className='flex'>More <span className='ml-1 arrow'> &#x25B4;</span></span>
                            <div className="hidden dropdown-content flex-col absolute z-10 text-black -translate-x-8 rounded-sm ">
                                <Link to="/orders"><i className="fas fa-folder"></i>Orders</Link>
                                <Link to="/cart"><i className="fas fa-cart-arrow-down"></i>Cart</Link>
                            </div>
                        </div>
                    </>}
                    ...
                    <span className='flex items-center cursor-pointer'>
                        {logged && <><Link to="/cart"><i className="fas fa-cart-plus"></i></Link>
                            <Link to="/cart"><p className='ml-2 hidden md:block'>Cart</p> </Link></>}
            ...
            <div className='bg-[#2874f0] md:hidden flex justify-center items-center -mt-1'>
                ...
                <input type="search" name="search" id="search" placeholder='Search for products, brands and more' className='text-sm px-9 py-2 w-full my-1 mr-3.5 rounded-sm ' />
            </div>
            ...
            {logged && <div className="h-[100vh] absolute top-0 bg-white border-1 border-gray-300 z-20 hidden w-full max-w-[66%] min-w-[50%] fade" id='hamItem'>
                ...
                <div className="items flex flex-col py-2" onClick={onClick}>
                    ...
                    <a href="/" className='py-2 '><i className="fas fa-coins mx-2"></i>Supercoin Zone</a>
                    <a href="/" className='py-2 '><i className="fas fa-plus mx-2"></i> Plus Zone</a>
                    <a href="/" className='py-2'><i className="fas mx-2 fa-gifts"></i>Big Sales</a><hr />
                    <Link to="/orders" className='py-2 '><i className="fas fa-folder mx-2"></i>My Orders</Link>
                    <a href="/" className='py-2 '><i className="fas fa-gift mx-2"></i>My Coupons</a><hr />
                    <a href="/" className='py-2'><i className="far mx-2 fa-bell"></i> Notifications</a>
                    <a href="/" className='py-2'><i className="fas mx-2 fa-question"></i>Customer Care</a><hr />
                    <a href="/" className='py-2'><i className="fas mx-2 fa-ad"></i>Advertise</a>
